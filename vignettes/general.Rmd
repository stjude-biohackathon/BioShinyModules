...
As mentioned in the well written [Shiny documentation](https://mastering-shiny.org/scaling-modules.html):
...
All modules available in this package has at least one demo function for you to experiment.
...
To add a module inside your application you will need to add the *ui* and the *server* part of the module
in each corresponding part of your app.
...
Thus in just a few line you've added 3 components that have independent namespace and work together nonetheless.
